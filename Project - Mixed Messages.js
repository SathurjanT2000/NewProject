...
const randomExerciseGeneration = (day, numberOfExercises) => {
    ...
    const amountOfShouldersWorkoutNumber = Math.ceil(0.5*(numberOfExercises - amountOfChestWorkout));
    const amountOfTricepsWorkoutNumber = numberOfExercises - (amountOfChestWorkout+amountOfShouldersWorkout);
    const amountOfBackWorkoutNumber = Math.ceil(0.5*numberOfExercises);
    const amountOfBicepsWorkoutNumber = numberOfExercises - amountOfBackWorkout;
    const chestWorkouts = [];
    ...
    const legWorkouts = [];
    day = day.toLowerCase();
    if ((day === undefined) || (numberOfExercises === undefined)) {
        console.log('Please input the corrext details')
    } else if (day === 'push') {
        do {
...
console.log(randomExerciseGeneration('push', 10));
